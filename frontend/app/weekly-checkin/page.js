      ...
      <main className="max-w-2xl mx-auto px-6 sm:px-8 py-10">
        {!userId ? (
          ...
          <div className="bg-white rounded-3xl shadow-sm p-10 text-center">
            <div className="mx-auto w-20 h-20 rounded-full bg-[#eaf3ea] flex items-center justify-center">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6f9b6f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <>
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="rounded-full bg-[#eaf3ea] px-3 py-1 text-sm text-[#4f7a52]">
                ...
                {OPTIONS.map((option) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {isSelected && <span className="w-3 h-3 rounded-full bg-[#6f9b6f]" />}
                      </span>
                      <span
